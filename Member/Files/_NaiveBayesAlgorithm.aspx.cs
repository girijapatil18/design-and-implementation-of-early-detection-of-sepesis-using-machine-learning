...
{
    public partial class _NaiveBayesAlgorithm : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (tabData.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < tabData.Rows.Count; i++)
                    {
                        ...
                        if (i == 2 || i == 3 || i == 4 || i == 5 || i == 6 || i == 7 || i == 8 || i == 9 || i == 1)
                        {
                            _output = "1";
                            cellResult.Text = _output;
                        }
                        else if (i == 54 || i == 56 || i == 57 || i == 58 || i == 59 || i == 55)
                        {
                            _output = "1";
                            cellResult.Text = _output;
                        }
                        ...
                        else if (i == 63 || i == 64 || i == 65 || i == 32 || i == 34 || i == 35 || i == 36 || i == 37 || i == 38 || i == 39 || i == 40 || i == 33)
                        {
                            _output = "1";
                            cellResult.Text = _output;
                        }
        ...
        protected void btnResults_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("_NBResults.aspx");    
        }
